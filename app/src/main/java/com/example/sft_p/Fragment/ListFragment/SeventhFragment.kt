...
class SeventhFragment : Fragment() {
    ...
    inner class DetailViewRecyclerViewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            ...
            firestore?.collection("피자")?.orderBy("timestamp")?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                contentDTOs.clear()
        ...
        fun favoriteEvent(position : Int){
            var tsDoc = firestore?.collection("피자")?.document(contentUidList[position])
