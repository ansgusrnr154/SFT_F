...
class ThirdFragment : Fragment() {
    ...
    inner class DetailViewRecyclerViewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            ...
            firestore?.collection("일식")?.orderBy("timestamp")?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                contentDTOs.clear()
        ...
        fun favoriteEvent(position : Int){
            var tsDoc = firestore?.collection("일식")?.document(contentUidList[position])
