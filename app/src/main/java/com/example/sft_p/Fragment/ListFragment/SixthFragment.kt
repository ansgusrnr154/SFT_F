...
class SixthFragment : Fragment() {
    ...
    inner class DetailViewRecyclerViewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        init {
            ...
            firestore?.collection("분식")?.orderBy("timestamp")?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                contentDTOs.clear()
        ...
        fun favoriteEvent(position : Int){
            var tsDoc = firestore?.collection("분식")?.document(contentUidList[position])
