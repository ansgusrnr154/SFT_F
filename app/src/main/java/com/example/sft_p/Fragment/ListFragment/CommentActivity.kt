...
class CommentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rstValue = intent.getStringExtra("rstValue")
        ...
        comment_btn_send?.setOnClickListener {
            ...
            FirebaseFirestore.getInstance().collection(rstValue!!).document(contentUid!!).collection("comments").document().set(comment)
